...
public class MissingPositiveInteger {
    ...
    public int firstMissingPositive(ArrayList<Integer> A) {
        ...
        for(int i=0;i<size;i++)
        {
            if(A.get(i)<=0)
                continue;
            else if(A.get(i)>size-1)
                continue;
            else if(A.get(i)==i+1)
                continue;
            else if(A.get(i)==A.get(A.get(i)-1))
              continue;
                ...
                else
                {
                    ...
                    A.set(temp-1,temp);
                    i--; //need to fix the i th position
                }
